...
\copyrightyear{2015} \submitdate{Noviembre 2015}
\convocation{Noviembre}{2015}
...
\twosupervisors
\profguia{Dr. Héctor Allende O.}      % Profesor Tutor
...
% ------------------------------------------------------------------------
    ...
    \include{2_introduccion/1_Introduccion}
    \include{3_conceptos-fisica/2_ConceptosFisica}
    \include{4_detector-preshower/4_DetectorPreshower}
    \include{6_algoritmo_reconstruccion/6_AlgoritmoReconstruccion}
    \include{5_estado_del_arte/5_EstadoDelArte}
    \include{7_experimentos/7_Experimentos}
    \include{8_conclusion/8_Conclusion}
    ...
    \appendixpage
    \appendix
    %\include{7_apendices/metodos_optimizacion}
    %\include{7_apendices/distribuciones}
    %\include{7_apendices/resultados_extras}

% ------------------------------------------------------------------------
% Se agrega la Bibliograf√≠a: Ojo, compilar con Latex y luego con Bibtex (2 veces)
% ------------------------------------------------------------------------
    \singlespacing
